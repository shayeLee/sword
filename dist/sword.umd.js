(function (global, factory) {
  ...
  */
  ...
  var domTool = {
     ...
     */
    getElementTop: function getElementTop(element, target) {
     ...
     */
    getElementLeft: function getElementLeft(element, target) {
  ...
  var domTool$1 = domTool;

  window.onload = function () {
    console.log(domTool$1.getElementLeft(document.getElementById("myDom"), document.documentElement));
  };
